      ...
      <div className="hidden px-8 lg:flex w-full">
        ...
        <div className="w-3/5 flex items-center justify-center">
          <Menu>
            ...
            >
              <SupportGrid supportItem={[]} supportMobile={{
                mobileFirst: "",
                mobileSecond: ""
              }} />
            </MenuItem>
            ...
            >
              <ResourceGrid supporItem={[]} ResourcesMobile={[]} />
            </MenuItem>
        ...
        {isOpen && (
          <div className="absolute top-14 left-0 w-full bg-gray-300/90 h-screen z-[99999] shadow-lg">
            <div className="bg-white h-2/3 p-4 flex-col space-y-3">
              ...
              {expandedItem === "About Us" && <AboutLayout category={""} data={{
                navLeftData: [],
                navRightData: []
              }} />}
              ...
              {expandedItem === "Support" && <SupportGrid supportItem={[]} supportMobile={{
                mobileFirst: "",
                mobileSecond: ""
              }} />}
              <div
              ...
              {expandedItem === "Resources" && <ResourceGrid supporItem={[]} ResourcesMobile={[]} />}
              <div
                className="flex justify-between items-center py-2 border-b"
              ...
              {expandedItem === "Video" && <ResourceGrid supporItem={[]} ResourcesMobile={[]} />}
              <div
                className="flex justify-between items-center py-2 border-b"
                onClick={() => expandItem("Video")}
              >
