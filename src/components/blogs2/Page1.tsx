...
import { Page1Data } from "../Constants/blogs/blogs2_data";
...
const Page1: React.FC<Page1Props> = ({ onCategorySelect }) => {
  ...
  return (
    <div className="lg:mt-[5.2rem] mt-[2vh] lg:ml-[3vw] lg:mr-[3vw]">
      <div className="lg:w-full lg:h-[82vh] lg:pr-8 lg:pb-0 pb-[2vh] lg:px-0 px-[6vw] lg:border-r-2 border-[#E6E7E6] overflow-auto sticky lg:top-[5.2rem] bg-[#f2f2f2] lg:rounded-none rounded-[0.5rem]">
        ...
        <div className="mt-3">
          ...
          <button
            ...
            className="text-red-600 font-poppins mt-1"
          >
