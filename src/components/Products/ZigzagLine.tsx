const ZigzagLine = () => {
    return (
      <div className="absolute -left-[40%] top-[50%] flex h-20 justify-center items-center">
        <svg
        ...
        >
          <defs>
            <clipPath id="6b7bcf8bd9">
              <path d="M 114.007812 537 L 1430.257812 537 L 1430.257812 962.960938 L 114.007812 962.960938 Z M 114.007812 537 " clipRule="nonzero" />
            </clipPath>
          </defs>
          <rect
            x="-150"
